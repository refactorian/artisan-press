<div>
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-2 text-xs text-zinc-500 dark:text-zinc-400">
                    ...
                    <select
                        ...
                        class="px-3 py-2 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-xs font-medium text-zinc-700 dark:text-zinc-300 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 dark:focus:ring-indigo-400/50 shadow-sm cursor-pointer"
                    >
                ...
                <!-- View Mode Toggles -->
                <div class="hidden sm:inline-flex items-center p-1 rounded-xl bg-zinc-100 dark:bg-zinc-800/80 border border-zinc-200/80 dark:border-zinc-700/60">
                    <button
                        type="button"
        ...
        <div class="flex flex-wrap items-center gap-2 pt-2">
            ...
            @if($selectedCategory !== '' || $selectedTag !== '' || $search !== '')
                <button
                    ...
                    class="ml-auto text-xs font-medium text-rose-500 hover:text-rose-600 dark:text-rose-400 underline underline-offset-2 flex items-center gap-1"
                >
    ...
    @if($selectedTag)
        <div class="mb-6 inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-indigo-50 dark:bg-indigo-950/60 border border-indigo-200 dark:border-indigo-800 text-xs text-indigo-700 dark:text-indigo-300">
            ...
            <button wire:click="$set('selectedTag', '')" class="hover:text-indigo-900 dark:hover:text-white">
    ...
    <div wire:loading.delay class="w-full mb-6">
        <div class="p-3 text-center rounded-xl bg-indigo-50/50 dark:bg-indigo-950/30 text-xs text-indigo-600 dark:text-indigo-400 flex items-center justify-center gap-2">
    ...
    @else
        ...
        <div class="text-center mt-2">
            <button wire:click="clearFilters" class="text-sm font-semibold text-indigo-600 dark:text-indigo-400 hover:underline">
