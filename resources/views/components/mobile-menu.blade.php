        ...
        >
            ...
            <div class="mt-4">
                <button
                    ...
                    class="w-full flex items-center gap-2 px-3 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-300 text-sm cursor-pointer"
                >
